    ...
    <>
      ...
      <div className="w-full px-4 sm:px-6 md:px-10 py-12 md:py-16 xl:py-20 flex flex-col xl:flex-row items-start justify-between gap-8">
        ...
        >
          ...
          <button
            onClick={() =>
              window.open("https://www.vtrader.io/en-ng", "_blank")
            }
      ...
      <div className="w-full h-[600px] sm:h-[420px] md:h-[520px] xl:h-[700px] px-4 sm:px-6 md:px-10 flex flex-col md:flex-row pb-12 md:pb-20 items-center justify-between gap-4">
        <motion.div
      ...
      <div className="px-4 sm:px-6 md:px-10 pb-12 md:pb-20 h-[900px] sm:h-[460px] md:h-[560px] xl:h-[600px] flex flex-col md:flex-row items-start justify-between gap-4 md:gap-7">
        <motion.img
