...
function Myosin() {
  ...
  return (
    <>
      ...
      <div className="px-4 sm:px-6 md:px-10 pb-12 md:pb-20 h-[600px] sm:h-[460px] md:h-[560px] xl:h-[600px] flex flex-col md:flex-row items-start justify-between gap-4 md:gap-7">
        <motion.img
